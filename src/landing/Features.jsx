            ...
            <div>
                ...
                <Row style={styles.row}>
                    ...
                    <div style={{width: '90%', margin: 'auto'}}>
                            ...
                            <Col xs={6} md={6}>
                                <img style={{height: 117, width: 150}} src={nowalletLogo}></img>
...
const styles = {
    ...
    text2: { fontSize: 16, fontFamily: 'SF Display Regular', lineHeight: 1, marginTop: 10, textAlign: 'left', width: '90%', margin: 'auto' },
