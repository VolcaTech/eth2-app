    ...
    render() {
        return (
            <div style={{display: 'block', margin: 'auto', width: '78%',}}>
              <Phone
		 ref={this.props._ref}		 
         inputStyle={{ width: '100%', height: 38, borderRadius: 12, border: '2px solid #f5f5f5', color: 'black', fontSize: 16, fontFamily: "SF Display Bold", letterSpacing: 1.94, WebkitBoxShadow: 'none'}}
