...
const styles = {
    title: { width: '70%', display: 'block', margin: 'auto', fontSize: 18, fontFamily: 'SF Display Black', textAlign: 'center',  },
    text1: { width: '90%', display: 'block', margin: 'auto', fontSize: 15, fontFamily: 'SF Display Regular', textAlign: 'center', },
    text2: { width: '80%', display: 'block', margin: 'auto', fontSize: 15, fontFamily: 'SF Display Regular', textAlign: 'center', },
    link: { width: '80%', display: 'block', margin: 'auto', wordWrap: 'break-word', fontSize: 12, color: '#0099ff', lineHeight: 1.3, fontFamily: 'SF Display Regular', textAlign: 'center', marginBottom: 43 },
}
...
const PendingSentTransfer = ({ transfer }) => {
    ...
    return (
        <div>
            <div style={{ display: 'flex', flexDirection: 'column', alignContent: 'space-between', height: 220 }}>
