        ...
        if (this.props.networkId != "3") {
            return (
                <div>
                    <div style={{ alignContent: 'center' }}>
                    <div><img src={e2pLogo} style={styles.e2pLogo} /></div>
                    <div style={styles.title}>Change network</div>
                    <div style={styles.instructionsContainer}>
                        <div style={styles.instructionsText}>1. Go to Settings.</div>
                        <div style={styles.instructionsText}>2. Change network to<div style={styles.ethereum}>Ethereum (ETH)</div></div>                       
                    </div>
                </div>
		</div>
            );
...
const styles = {
    ...
    ethereum: { display: "inline-block", fontSize: 12, fontFamily: "SF Display Bold", opacity: 1, marginLeft: 3 },    
}
